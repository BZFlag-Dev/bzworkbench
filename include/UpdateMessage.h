...
public:
	...
	enum UpdateMessageType {
		...
		REMOVE_PHYDRV,				// i.e. remove a physics driver
	...
	*/
	...
	UpdateMessage( int _type, physics* _data ) {
		this->type = _type;
		this->data.phys = _data;
	}
	...
	physics* getAsPhysicsDriver() { return data.phys; }
